class BookResponseEntity {
	String msg;
	int code;
	List<BookResponseData> data;

	BookResponseEntity({this.msg, this.code, this.data});

	BookResponseEntity.fromJson(Map<String, dynamic> json) {
		msg = json['msg'];
		code = json['code'];
		if (json['data'] != null) {
			data = new List<BookResponseData>();(json['data'] as List).forEach((v) { data.add(new BookResponseData.fromJson(v)); });
		}
	}
